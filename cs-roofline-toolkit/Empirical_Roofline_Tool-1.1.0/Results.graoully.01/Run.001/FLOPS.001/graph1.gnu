...
set nox2tics
set noy2tics
set title "Graph 1 (Results.graoully.01/Run.001/FLOPS.001)"
...
set output "Results.graoully.01/Run.001/FLOPS.001/graph1.ps"
plot "Results.graoully.01/Run.001/FLOPS.001/pre" using 2:4
#EOF
