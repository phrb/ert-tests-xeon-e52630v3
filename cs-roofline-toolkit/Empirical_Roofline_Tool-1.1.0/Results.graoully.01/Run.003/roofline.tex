...
\begin{tikzpicture}
  ...
  \begin{loglogaxis}[
    title={Empirical Roofline Graph (Results.graoully.01/Run.003)},
    grid=both,
    ...
    \node[maxlabel] at (axis cs: 2.0000000e+00,1.4532000e+01) {12.1 GFLOPs/sec};
    ...
    \node[label={180:{Best Achieved GEMV}},circle,fill,inner sep=2pt] at (axis cs:0.25,0.6898) {};
